...
class UIRenderer {
    ...
    `;
        ...
        // 绑定事件
        (_a = document.getElementById('confirmDelete')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
            callback();
            document.body.removeChild(confirmBox);
            document.body.removeChild(mask);
        });
        (_b = document.getElementById('cancelDelete')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
            document.body.removeChild(confirmBox);
            document.body.removeChild(mask);
